...
let s:N1   = [ '#27323f' , '#738191' , 17  , 190 ]
let s:N2   = [ '#f9fbfa' , '#405368' , 255 , 238 ]
let s:N3   = [ '#47ebb4' , '#27323f' , 85  , 234 ]
...
let g:airline#themes#Base2Tone_SeaDark#palette.normal_modified = {
      \ 'airline_c': [ '#f9fbfa' , '#405368' , 255     , 53      , ''     ] ,
      \ }

let s:I1 = [ '#27323f' , '#2aeaaa' , 17  , 45  ]
let s:I2 = [ '#f9fbfa' , '#004a9e' , 255 , 27  ]
let s:I3 = [ '#47ebb4' , '#27323f' , 15  , 17  ]
...
let g:airline#themes#Base2Tone_SeaDark#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#067953' , s:I1[2] , 172     , ''     ] ,
      \ }

let g:airline#themes#Base2Tone_SeaDark#palette.replace = copy(g:airline#themes#Base2Tone_SeaDark#palette.insert)
let g:airline#themes#Base2Tone_SeaDark#palette.replace.airline_a = [ s:I2[0]   , '#004a9e' , s:I2[2] , 124     , ''     ]
...
let s:V1 = [ '#27323f' , '#6e9bcf' , 232 , 214 ]
let s:V2 = [ '#f9fbfa' , '#004a9e' , 232 , 202 ]
let s:V3 = [ '#f9fbfa' , '#27323f' , 15  , 52  ]
...
let s:IA1 = [ '#405368' , '#27323f' , 239 , 234 , '' ]
let s:IA2 = [ '#405368' , '#27323f' , 239 , 235 , '' ]
let s:IA3 = [ '#405368' , '#27323f' , 239 , 236 , '' ]

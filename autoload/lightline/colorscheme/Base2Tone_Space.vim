...
" condition vim-colors-Base2Tone_Space uses to determine which set of colors
" to use.
let s:Base2Tone_Space_termcolors = get(g:, 'Base2Tone_Space_termcolors', 256)
if s:Base2Tone_Space_termcolors != 256 && &t_Co >= 16
  let s:cuiindex = 0
elseif s:Base2Tone_Space_termcolors == 256
  let s:cuiindex = 1
else
  let s:cuiindex = 2
endif

let s:base03 = [ '#24242e', s:cuicolors.base03[s:cuiindex] ]
let s:base02 = [ '#333342', s:cuicolors.base02[s:cuiindex] ]
let s:base01 = [ '#737391', s:cuicolors.base01[s:cuiindex] ]
let s:base00 = [ '#8a8aa3', s:cuicolors.base00[s:cuiindex] ]
let s:base0 = [ '#a1a1b5', s:cuicolors.base0[s:cuiindex] ]
let s:base1 = [ '#b8b8c7', s:cuicolors.base1[s:cuiindex] ]
let s:base2 = [ '#cecee3', s:cuicolors.base2[s:cuiindex] ]
let s:base3 = [ '#ebebff', s:cuicolors.base3[s:cuiindex] ]
let s:yellow = [ '#fe8c52', s:cuicolors.yellow[s:cuiindex] ]
let s:orange = [ '#f37b3f', s:cuicolors.orange[s:cuiindex] ]
let s:red = [ '#5151e6', s:cuicolors.red[s:cuiindex] ]
let s:magenta = [ '#767693', s:cuicolors.magenta[s:cuiindex] ]
let s:violet = [ '#6363ee', s:cuicolors.violet[s:cuiindex] ]

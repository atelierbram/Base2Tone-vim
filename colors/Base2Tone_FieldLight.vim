" Base2Tone_FieldLight (https://github.com/atelierbram/Base2Tone-vim)
...
hi clear
syntax reset
let g:colors_name = "Base2Tone_FieldLight"
...
hi TermCursorNC ctermfg=231    ctermbg=248    guifg=s:gui00 guibg=s:gui09 guisp=NONE cterm=NONE gui=NONE

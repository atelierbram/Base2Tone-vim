" Base2Tone_MotelDark (https://github.com/atelierbram/Base2Tone-vim)
...
hi clear
syntax reset
let g:colors_name = "Base2Tone_MotelDark"
...
hi TermCursorNC ctermfg=236    ctermbg=38     guifg=s:gui00 guibg=s:gui09 guisp=NONE cterm=NONE gui=NONE

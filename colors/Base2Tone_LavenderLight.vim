" Base2Tone_LavenderLight (https://github.com/atelierbram/Base2Tone-vim)
...
hi clear
syntax reset
let g:colors_name = "Base2Tone_LavenderLight"
...
hi TermCursorNC ctermfg=231    ctermbg=147    guifg=s:gui00 guibg=s:gui09 guisp=NONE cterm=NONE gui=NONE

" Base2Tone_EveningLight (https://github.com/atelierbram/Base2Tone-vim)
...
hi clear
syntax reset
let g:colors_name = "Base2Tone_EveningLight"
...
hi TermCursorNC ctermfg=s:cterm00 ctermbg=s:cterm0E guifg=s:gui00 guibg=s:gui0E guisp=NONE cterm=NONE gui=NONE

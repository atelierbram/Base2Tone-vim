" Base2Tone_DesertDark (https://github.com/atelierbram/Base2Tone-vim)
...
hi clear
syntax reset
let g:colors_name = "Base2Tone_DesertDark"
...
hi TermCursorNC ctermfg=236    ctermbg=173    guifg=s:gui00 guibg=s:gui09 guisp=NONE cterm=NONE gui=NONE

" Base2Tone-Morning-light (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/Base2Tone-Morning-light.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "Base2Tone-Morning-light"
...
call <sid>hi("IncSearch",     s:gui00, s:gui09, s:cterm00, s:cterm09, "none")
...
call <sid>hi("Search",        s:gui00, s:gui0B, s:cterm00, s:cterm0B,  "")
